...
- **00:00 에 켜고 06:00 에 끈다.** 1분마다 확인한다.
- **결산이 끝난 것을 보면 그날 밤 확인을 끈다.** 다음 날 00:00 에 다시 켠다.
...
**실측 구간은 여섯 밤이 모두 같았다.** 00:00 대에 결산 중이 되고 02:00 대에 끝났다. 끝나는 02:00
은 넥슨의 경계다(1분마다 묻는데 여섯 밤 모두 02:00 의 첫 타점에 잡혔고 구간 길이 상한이 없다).
**시작하는 00:00 은 아니다.** 자정에 묻는 날짜가 어제로 바뀌는 순간이라, 그 전에 시작한 결산이
있어도 못 본다.
